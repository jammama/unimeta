...
public class Result extends LinkedHashMap<String, Object> {
    ...
    public static Result resultWithMessage(int result, String message) {
        return buildResult(result, message);
    }
...
//                        (oldValue, newValue) -> oldValue, LinkedHashMap::new));
    ...
    private static Result buildResult(Integer result, Object data) {
        ...
        if (nonNull(data)) {
            if (data instanceof String) {
                ...
                ((LinkedHashMap<String, Object>) data).forEach((key, value) -> returnResult.put(key, value));
            } else {
    ...
    private static void addData(Result result, String data) {
//        return result;
    }

    private static void addData(Result result, LinkedHashMap<String, Object> data) {
//        return result;
    }
